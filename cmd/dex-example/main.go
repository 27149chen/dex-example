...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://example.test.8slan.com/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "http://dex.test.8slan.com/dex", "URL of the OpenID Connect issuer.")
	c.Flags().StringVar(&listen, "listen", "http://example.test.8slan.com", "HTTP(S) address to listen at.")
